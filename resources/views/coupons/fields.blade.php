...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <!-- Salon Id Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('salons[]', trans("lang.coupon_salon_id"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('salons[]', $salon, $salonsSelected, ['class' => 'select2 form-control', 'multiple'=>'multiple']) !!}
            <div class="form-text text-muted">{{ trans("lang.coupon_salon_id_help") }}</div>
        </div>
    </div>
