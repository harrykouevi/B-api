...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        ...
        <div class="col-md-9">
            {!! Form::text('name', null,  ['class' => 'form-control','placeholder'=>  trans("lang.option_template_name_placeholder")]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.option_template_name_help") }}
            </div>
        </div>
    </div>
    ...
    <div class="form-group align-items-start d-flex flex-column flex-md-row">
        ...
        <div class="col-md-9">
            ...
            <div class="form-text text-muted w-50">
                {{ trans("lang.option_template_image_help") }}
            </div>
        </div>
    </div>
    @prepend('scripts')
...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        ...
        <div class="col-md-9">
            {!! Form::number('price', null, ['class' => 'form-control','step'=>'any', 'min'=>'0', 'placeholder'=> trans("lang.option_template_price_placeholder")]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.option_template_price_help") }}
            </div>
        </div>
    </div>
