                ...
                <div class="col-md-3">
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body box-profile">
                            ...
                            <a class="btn btn-outline-{{setting('theme_color')}} btn-block" href="mailto:{{$user->email}}"><i class="fas fa-envelope mr-2"></i>{{$user->email}}
                            </a>
                        </div>
                        <!-- /.card-body -->
                    </div>
                        ...
                        <div class="card-header">
                            <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                                ...
                                <div class="ml-auto d-inline-flex">
                                    <li class="nav-item">
                                        <a class="nav-link pt-1" href="{{ route('salons.create') }}"><i class="fas fa-check-o"></i> {{trans('lang.app_setting_become_servicsalon')}}
                                        </a>
                                    </li>
                                </div>
                                @endhasrole
