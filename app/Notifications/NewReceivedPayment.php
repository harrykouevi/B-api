...
class NewReceivedPayment extends Notification
{
    ...
    public function toFcm($notifiable): FcmMessage
    {
        ...
        $notification = [
            'body' => trans('lang.notification_payment', ['payment_id' => $this->payment->id, 'payment_status' => trans('lang.payment_statuses.'.$this->payment->paymentStatus->status) , 'payment_amount' => $this->payment->amount]),
