...
class ModelServiceController extends Controller
{
    ...
    {
        return $modelServiceDataTable->render('model_services.index');
    }
    ...
    public function create(): View
    {
        ...
        return view('model_services.create')->with("customFields", $html ?? false)->with("category", $category)->with("categoriesSelected", $categoriesSelected)->with("salon", $salon);
    }
    ...
    public function show(int $id): RedirectResponse|View
    {
        ...
        return view('model_services.show')->with('eService', $eService);
    }
    ...
    public function edit(int $id): RedirectResponse|View
    {
        ...
        return view('model_services.edit')->with('eService', $eService)->with("customFields", $html ?? false)->with("category", $category)->with("categoriesSelected", $categoriesSelected)->with("salon", $salon);
    }
